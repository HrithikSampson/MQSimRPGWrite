...
namespace SSD_Components
{
	...
	{
	    //c=new ClockAlgo(channel_no,chip_no_per_channel,die_no_per_chip,plane_no_per_die
	...
	void FTL::get_amu()
	{
		((Address_Mapping_Unit_Page_Level*) (this->Address_Mapping_Unit))->print_pv_aware_data("preconditioning done . pv aware data:");
