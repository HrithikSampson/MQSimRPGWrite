...
#define All_VALID_PAGE 0x0000000000000000ULL
    ...
    */
	...
	public:
		...
		bool srch(Block_Pool_Slot_Type* new_block);
		...
		std::list<Block_Pool_Slot_Type*> RPG_Blocks; 
	...
	public:
		...
		virtual void Allocate_block_and_page_in_plane_for_RPG_write(const stream_id_type streamID, NVM::FlashMemory::Physical_Page_Address& page_address) = 0;
